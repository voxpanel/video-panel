...
mysql_query("Update video.streamings set senha = '".$_POST["senha"]."', senha_transmissao = '".$_POST["senha_transmissao"]."', player_titulo = '".addslashes($_POST["player_titulo"])."', player_descricao = '".addslashes($_POST["player_descricao"])."', player_autoplay = '".$_POST["player_autoplay"]."', player_volume_inicial = '".$_POST["player_volume_inicial"]."', timezone = '".$_POST["timezone"]."', formato_data = '".$_POST["formato_data"]."' where codigo = '".$dados_stm["codigo"]."'");

// Verifica se a senha de transmissão ao vivo foi alterada e atrualiza no servidor.
    ...
    <div class="tab-pane" id="tabPane1">
      ...
      <div class="tab-page" id="tabPage3">
        ...
        <table width="690" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#F4F4F7; border-bottom:#CCCCCC 1px solid; border-left:#CCCCCC 1px solid; border-right:#CCCCCC 1px solid;">
          ...
          <tr>
            <td width="150" height="30" align="left" class="texto_padrao_destaque" style="padding-left:5px;"><?php echo $lang['lang_info_config_stm_player_titulo']; ?></td>
            <td align="left" class="texto_padrao"><input name="player_titulo" type="text" class="input" id="player_titulo" style="width:250px;" value="<?php echo $dados_stm["player_titulo"]; ?>" />&nbsp;<img src="img/icones/ajuda.gif" title="Ajuda sobre este item." width="16" height="16" onclick="alert('<?php echo $lang['lang_info_config_stm_player_titulo_info']; ?>');" style="cursor:pointer" /></td>
          </tr>
          <tr>
            <td height="30" align="left" class="texto_padrao_destaque" style="padding-left:5px;"><?php echo $lang['lang_info_config_stm_player_descricao']; ?></td>
            <td align="left" class="texto_padrao"><input name="player_descricao" type="text" class="input" id="player_descricao" style="width:250px;" value="<?php echo $dados_stm["player_descricao"]; ?>" />&nbsp;<img src="img/icones/ajuda.gif" title="Ajuda sobre este item." width="16" height="16" onclick="alert('<?php echo $lang['lang_info_config_stm_player_descricao_info']; ?>');" style="cursor:pointer" /></td>
          </tr>
        </table>
      </div>
      <div class="tab-page" id="tabPage3">
